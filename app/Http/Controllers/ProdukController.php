...
class ProdukController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('produks.create',compact('produks', 'categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $selectedkategori = produks::findOrFail($produks->id)->id_categories;
    ...
    public function update(Request $request, $id)
    {
        ...
        if($new_cover){
        if($produk->cover && file_exist.s(storage_path('app/public/' . $produk->cover))){
